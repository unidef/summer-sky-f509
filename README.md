...
```
npm create cloudflare@latest -- --template=cloudflare/templates/summer-sky-f509
```

A live public deployment of this template is available at [https://summer-sky-f509.templates.workers.dev](https://summer-sky-f509.templates.workers.dev)
